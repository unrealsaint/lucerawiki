...
export default function NobleRaidBossGuide() {
  return (
    <>
      {/* Header */}
      ...
      <div className="layout-content">
        <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
          <article className="prose prose-invert max-w-none">
            <h1>Noble Raid Boss Guide</h1>
            <p className="lead">
              Learn how to configure Raid Bosses that grant Noble status without requiring the quest.
            </p>

            <h2>Configuration</h2>
            <p>
              To make a Raid Boss grant Noble status without requiring the quest, you need to modify the NPC's type in its configuration file:
            </p>
            <div className="bg-gray-800 p-4 rounded-lg my-4">
              <pre className="text-sm">
{`<npc id="25325" name="Flame of Splendor Barakiel" title="Raid Boss">
  <!-- ... other configurations ... -->
  <set name="type" value="NoblesRewardBoss"/>
  <!-- ... other configurations ... -->
</npc>`}
              </pre>
            </div>
            ...
            <h2>Requirements</h2>
            <p>
              Players must meet the following conditions to receive Noble status:
            </p>
            <ul>
              <li>Must be in a party</li>
              <li>Must be within 1500 units of the Raid Boss when it dies</li>
              <li>Must be on a subclass</li>
              <li>Must be level 76 or higher</li>
            </ul>

            <h2>Example Configuration</h2>
            <p>
              Here's a complete example using Barakiel as the Noble-granting Raid Boss:
            </p>
            <div className="bg-gray-800 p-4 rounded-lg my-4">
              <pre className="text-sm">
{`<npc id="25325" name="Flame of Splendor Barakiel" title="Raid Boss">
      ...
      <reward item_id="8619" min="1" max="1" chance="33.3333"/>
            ...
            <div className="bg-yellow-900/30 border border-yellow-800 rounded-lg p-4 my-4">
              ...
              <ul className="list-disc list-inside text-yellow-100">
                <li>Choose appropriate Raid Bosses for Noble status rewards</li>
                ...
                <li>Document which Raid Bosses grant Noble status</li>
